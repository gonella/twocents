...
import com.twocents.report.charts.StandardPieItemLabelGenerator;
...
public class MultipieChart extends ApplicationFrame {
     ...
     */
    public MultipieChart(final String title) {
    ...
    public static void main(final String[] args) {
        ...
        final MultipieChart demo = new MultipieChart("Multiple Pie Chart Demo 1");
        demo.pack();
