...
public class ViewerApp extends ApplicationWindow {
	...
	public ViewerApp(Composite arg0,int layout) {
		super(arg0.getShell());
	...
	/*public Control createContents(Composite parent) {
		...
		Control reportViewerControl = reportViewer.createControl(composite);
		reportViewerControl.setLayoutData(new GridData(GridData.FILL_BOTH));

		StatusBar statusBar = new StatusBar();
		statusBar.setReportViewer(reportViewer);
		Control statusBarControl = statusBar.createControl(composite);
	...
	public static void main(String[] args) {
		...
		String fileName="/com/jasperassistant/designer/viewer/actions/xml/Report.jrxml";
